...
- O Frontend nao muda seu contrato publico: continua chamando `/api/v1/questoes` pelo BFF.
- Consultas futuras que precisarem mostrar nome/email de autores devem ser compostas por API, preferencialmente no BFF com lookup em lote.
