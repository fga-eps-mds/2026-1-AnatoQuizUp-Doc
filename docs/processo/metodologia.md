...
- **Backlog**: itens da release ainda não puxados para a sprint.
- **Sprint Backlog**: itens comprometidos para a sprint atual.
- **Em Andamento**: alguém está ativamente trabalhando.
- **Em Revisão**: PR aberto aguardando code review.
- **Concluído**: merge na `main` + DoD atendida.
