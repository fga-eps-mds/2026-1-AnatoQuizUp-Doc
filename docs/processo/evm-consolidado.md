...
- o **`AC` usa a equipe efetiva de cada sprint** (12 → 10 → 9 integrantes), que encolheu;
...
| S6 | 9 | 232 | 196 | 23.447,40 | 19.809,01 | 18.895,58 | 0,84 | 1,05 |
| S7 | 9 | 236 | 196 | 27.355,30 | 22.718,81 | 21.828,09 | 0,83 | 1,04 |
| S8 | 9 | 248 | 223 | 31.263,20 | 28.111,67 | 24.760,60 | 0,90 | 1,14 |
| S9 | 9 | 253 | 226 | 35.171,10 | 31.417,66 | 27.693,11 | 0,89 | 1,13 |
| **S10** | 9 | 253 | 236 | 39.079,00 | 36.453,14 | 30.625,62 | **0,93** | **1,19** |

**Posição final (S10):** SPI **0,93** · CPI **1,19** · EAC **R$ 32.831,70** · VAC **+R$ 6.247,30** (projeção de término ~R$ 6,2 mil **abaixo** do BAC de R$ 39.079,00).

## 4. Leitura

- **SPI 0,93 (cronograma).** O time entregou ~93% do escopo que **planejou nas sprints**. O backlog de ambição que nunca entrou em sprint (cards de Icebox/Product Backlog, encerrados na limpeza de board ao fim do semestre) é **descopo** — mudança de baseline, não atraso —, por isso não entra no PV.
- **CPI 1,19 (custo) — atenção à interpretação.** O projeto está **abaixo do orçamento**, mas isso **não é eficiência**: o baseline assumiu 12 integrantes e a equipe caiu para 9. Menos pessoas ⇒ menos custo real (AC) ⇒ CPI > 1. O mesmo encolhimento explica o SPI < 1. São **dois efeitos da mesma causa** (perda de equipe), agora visíveis separadamente porque CPI ≠ SPI.
- **Trajetória do CPI.** Sai de 0,78 (S1–S2, equipe cheia e entrega inicial baixa) e cruza 1,0 na **S5**, quando a equipe já reduzida (9) passa a custar abaixo do plano de 12.
...
## 5. PRP — Pontos Planejados por Release

O **PRP** (pontos planejados por release) agrega o PV(SP) das sprints de cada release major. Como a equipe encolheu de **12 → 10 → 9** já nas sprints S2–S3, a capacidade e o planejado das releases seguintes acompanharam a queda:

| Release | Sprints | Equipe | PRP (SP plan.) | Entregue (SP) | SPI release |
|---|---|---:|---:|---:|---:|
| **R1** — Major 1 | S1 | 12 | 91 | 71 | 0,78 |
| **R2** — Major 2 | S2–S5 | 10 → 9 | 115 | 122 | 1,06 |
| **R3** — Major 3 | S6–S10 | 9 | 47 | 43 | 0,91 |

A **R3 foi planejada com bem menos pontos** (47 SP) que a R2 (115 SP) — efeito da equipe menor somado ao descopo (gamificação/IA além do MVP movidos para o fim da fila). O detalhamento sprint a sprint (com a marcação de onde a equipe caiu) está no [Dashboard de Projeto](https://fga-eps-mds.github.io/2026-1-AnatoQuizUp-Doc/dashboards/projeto.html).
...
| 29/06/2026 | 2.1 | Equipe efetiva corrigida para 9 integrantes nas sprints S6–S10 (Caio permaneceu ativo); SPI 0,93 · CPI 1,19 · EAC R$ 32.831,70 · VAC +R$ 6.247,30; adicionada a seção PRP por release | [Miguel Moreira](https://github.com/EhOMiguel) |
